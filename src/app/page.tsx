...
// All static data and reusable styles are centralized here.
// ===========================================
...
// For better organization within this file.
// ===========================================

const PageHeader = () => (
    <header className="relative z-10 pt-9 px-4 sm:px-8 lg:px-[86px] flex flex-col lg:flex-row items-center justify-between w-full gap-8">
...
const HeroSection = ({ agentMode, setAgentMode }) => (
    <section className="relative w-full mt-20 lg:mt-[180px]">
      <img
        ...
        src="/Leftcircle.svg"
      />
      <div className="relative w-full max-w-[95%] lg:max-w-[85%] mx-auto flex flex-col lg:flex-row items-center justify-between gap-12 px-4 sm:px-8 md:px-12">
...
const VideoSection = () => (
    <section className="w-full mt-24 lg:mt-40">
      <Card className="w-[80%] h-[700px] mx-auto bg-[#1A1A1A] border border-solid border-[#484848] rounded-xl flex items-center justify-center">
        <CardContent className="w-full h-full p-4">
          {/* This is where your video component or iframe will go */}
...
const PopularCoursesSection = () => (
    <section className="flex flex-col w-full max-w-[1330px] items-center gap-[60px] mx-auto mt-[200px] px-4">
      ...
      <div className="relative w-full h-auto lg:h-[880px]">

        {/* --- Course Cards --- */}
        {/* Each card is relative on mobile and stacks. On lg screens, it becomes absolute to match the original design */}
        
        {/* Deep Cloud & Multi-Cloud Engineering */}
        <Card className="relative w-full mb-8 lg:absolute lg:top-0 lg:left-0 lg:w-[1330px] lg:h-[431px] rounded-xl border border-solid border-[#484848] bg-[#1A1A1A] overflow-hidden">
        ...
        <Card className="relative w-full mb-8 lg:absolute lg:w-[830px] lg:h-[336px] lg:top-[447px] lg:left-0 rounded-xl border border-solid border-[#484848] bg-[#1a1a1a] overflow-hidden">
            <CardContent className="p-3 flex flex-col md:flex-row h-full gap-3">
        ...
        {/* Fintech Engineering */}
        <Card className="relative w-full mb-8 lg:absolute lg:w-[485px] lg:h-[336px] lg:top-[447px] lg:left-[846px] rounded-xl border border-solid border-[#484848] bg-[#1a1a1a]">
        ...
        {/* UI/UX with Blender */}
        <Card className="relative w-full mb-8 lg:absolute lg:w-[485px] lg:h-[78px] lg:top-[799px] lg:left-0 rounded-xl border border-solid border-[#484848] bg-[#1a1a1a]">
        ...
        {/* RISC-V CPU Design */}
        <Card className="relative w-full mb-8 lg:absolute lg:w-[830px] lg:h-[78px] lg:top-[799px] lg:left-[501px] rounded-xl border border-solid border-[#484848] bg-[#1a1a1a]">
          <CardContent className="p-6 h-full flex items-center justify-between">
...
const TimelineSection = () => (
    <section className="relative w-full mt-32 mb-32 px-4">
      <div className="relative w-full ">
        ...
        <Card className="relative mx-auto w-full max-w-[1330px] rounded-xl border border-solid border-[#484848] bg-[#1a1a1a]">
          <CardContent className="p-8 md:p-12">
            ...
            <div className="relative w-full px-4 md:px-12 py-8">
                <div className="relative flex justify-between items-center">
                    ...
                    {/* Foreground line for active phases */}
                    ...
                    {timelinePhases.map((phase, index) => (
                      <div key={index} className={`relative z-10 flex flex-col items-center text-center w-1/4 ${phase.active ? "" : "opacity-40"}`}>
                        {/* Text Above container with fixed height */}
                        ...
                        {/* Text Below container with fixed height */}
...
const PageFooter = () => (
    <footer style={{ background: '#4187F7' }} className="font-['Plus_Jakarta_Sans',Helvetica] text-white flex items-center justify-center p-8">
      <div className="w-full max-w-[85%] h-full flex flex-col justify-center">
