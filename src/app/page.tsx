...
// REMOVED: Select component is no longer needed
// import {
//   Select,
//   SelectContent,
//   SelectItem,
...
// ===========================================
// PAGE COMPONENTS
// (Header, Video, etc. - No changes needed here, they are included for completeness)
// ===========================================
...
// CHANGED: Removed agentMode props
const HeroSection = () => (
  <section className="relative w-full mt-16 lg:mt-[180px]">
    ...
    <ContentContainer className="relative flex flex-col lg:flex-row items-center justify-between gap-12">
      ...
      <div className="w-full max-w-[500px] flex-shrink-0 relative z-10 flex flex-col items-center gap-6 mt-12 lg:mt-0">
        {/* REMOVED: The Select component and its label */}
...
// ... (Rest of the unchanged components like VideoSection, PopularCoursesSection, etc.)
const VideoSection = () => (
              ...
              <div className="flex flex-col lg:flex-row justify-between items-start py-8 border-b border-white/50 gap-8">
                  ...
                  >
                    <div className="flex items-center justify-between w-full">
                      ...
                      {/* Right side: Image */}
                      <img
                        src="/arrowright.svg" // Replace with actual path
                        alt="Arrow"
                        className="w-5 h-5"
                      />
                    </div>
...
const AestrAlpha = (): JSX.Element => {
  // REMOVED: agentMode state is no longer needed
  ...
  return (
    <div className="bg-black w-full min-h-screen font-['Plus_Jakarta_Sans',Helvetica]">
      <div className="bg-black overflow-x-hidden relative w-full min-h-screen">
        <PageHeader />
        <main>
          {/* CHANGED: Removed props from HeroSection */}
          <HeroSection />
          <VideoSection />
